...
const ExtractPhotosComponent: React.FC = () => {
  const imageUrls = [
    'projects/python/extract_photos_1.png',
    'projects/python/extract_photos_2.png',
    'projects/python/extract_photos_3.png'
  ];
  ...
  const sourceUrl = 'https://github.com/Wosiu6/extract-pictures';
